	...
	<body>
		...
		<div id="show-distribuidora" class="content scaffold-show" role="main">
			...
			<ol class="property-list distribuidora">
				...
				<g:if test="${distribuidoraInstance?.nome}">
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="distribuidora.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${distribuidoraInstance}" field="nome"/></span>
			...
			<g:form url="[resource:distribuidoraInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${distribuidoraInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
