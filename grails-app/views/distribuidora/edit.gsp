...
<html>
	...
	<body>
		...
		<div id="edit-distribuidora" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${distribuidoraInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${distribuidoraInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:distribuidoraInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${distribuidoraInstance?.version}" />
				<fieldset class="form">
