	...
	<body>
		...
		<div id="show-item" class="content scaffold-show" role="main">
			...
			<ol class="property-list item">
				...
				<g:if test="${itemInstance?.indice}">
				<li class="fieldcontain">
					<span id="indice-label" class="property-label"><g:message code="item.indice.label" default="Indice" /></span>
					
						<span class="property-value" aria-labelledby="indice-label"><g:fieldValue bean="${itemInstance}" field="indice"/></span>
